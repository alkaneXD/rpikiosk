...
operation on the 1st instance of '2) WebPrint/WebPrint.py' that is found in the
process list.
...
def parse_args():
    """Parse the arguments supplied.  Returns a list of valid arguments,
    prints an error message reporting any missing or invalid
    arguments.
    """
...
def main():
    ...
    arguments.  The following arguments are recognised -

    * start - start a new instance of the WebPrint
    * stop - stops the 1st instance of the WebPrint found running
    * restart - performs a stop then a start
    """

    args = parse_args()
    launch_command = ['python',
                      get_absolute_filename('2_Web_Print/WebPrint.py')]
